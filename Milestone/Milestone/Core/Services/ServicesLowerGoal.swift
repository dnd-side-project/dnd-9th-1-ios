...
protocol ServicesLowerGoal: Service {
    ...
    /// 하위 목표 생성 API 요청
    func requestPostLowerGoal(id: Int, reqBody: NewLowerGoal) -> Observable<Result<EmptyDataModel, APIError>>
    /// 하위 목표 완료 API 요청
    ...
    /// 하위 목표 수정 API 요청
    func requestEditLowerGoal(id: Int, reqBody: NewLowerGoal) -> Observable<Result<EmptyDataModel, APIError>>
    /// 하위 목표 삭제 API 요청
